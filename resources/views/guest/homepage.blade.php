    ...
    <div class="relative z-10 p-8 bg-gray-300 bg-opacity-90 rounded-lg shadow-md">
        ...
        <form class="space-y-4">
            <div class="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
                <div class="flex-grow">
                    <input type="text" class="w-full md:w-80 p-3 bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" id="address" name="address" placeholder="Enter your address">
                </div>
                <div class="flex-grow">
                    <input type="text" class="w-full md:w-80 p-3 bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" id="date" name="date" placeholder="Enter the date">
                </div>
            </div>
...
<section class="cops-profile bg-light py-5">
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-3 mb-4">
        <div class="image-box">
          <img src="https://scontent.fpnh10-1.fna.fbcdn.net/v/t1.6435-9/78669289_3208595915881655_4300997442968485888_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=5f2048&_nc_ohc=qNoMo_e91gUQ7kNvgHGpy2B&_nc_ht=scontent.fpnh10-1.fna&oh=00_AYD7yxvl4qRkRLJjwoatDfMuJdCY9h5GdSM1VqdM7ij5gQ&oe=667A7E20" alt="Police 3" class="img-fluid rounded-circle mx-auto d-block profile-image">
        </div>
