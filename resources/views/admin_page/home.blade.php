...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Navbar-->
        <a class="navbar-brand ps-3" href="#">Hello! <span>{{$admin->admin_username}}</span></a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center">CrimeTrack</h1>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="recentCrimesTable" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>Crime Type</th>
                                                <th>Address</th>
                    ...
                    <!-- Recently Joined Users and Crime Chart -->
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="recentUsersTable" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>First Name</th>
                                                <th>Last Name</th>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="crimeChartContainer" style="height: 400px; width: 100%;">
