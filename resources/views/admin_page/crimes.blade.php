...
<body class="sb-nav-fixed">
                                ...
                                <tbody>
                                    @foreach($crimes as $crime)
                                        <tr>
                                            ...
                                            <td>{{ $crime->reportedBy->username }}</td>
                                            <td>{{ $crime->approvedBy->admin_username }}</td>
                                            <td>
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="editCrimeForm{{ $crime->id }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select" id="address{{ $crime->id }}"
                                                                    name="address"
                                                                    onchange="toggleOtherInput({{ $crime->id }})">
                                                                    <option disabled selected>{{ $crime->address }}
                                                                    </option>
                                                                    <option value="Phnom Penh">Phnom Penh</option>
                                                                    <option value="Banteay Meanchey">Banteay Meanchey
                                                                    </option>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="map{{ $crime->id }}"
                                                                    class="form-label">Location:</label>
                                                                <div id="map{{ $crime->id }}" style="height: 200px;"></div>
                                                            </div>
    ...
    <script>
        var crimes = @json($crimes);
    </script>
    <script src="js/editCrimeMap.js"></script>
</body>
