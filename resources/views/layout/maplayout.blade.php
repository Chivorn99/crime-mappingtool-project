                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4 font-semibold text-xl">
                                ...
                                <a href="{{ url('/map') }}"
                                    class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Map</a>
                                <a href="{{ url('/aboutUspage') }}"
                                    class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About
                                    Us</a>
                                <a href="{{ url('/contact-us-auth') }}"
                                    class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact
                                    Us</a>
                                <a href="{{ url('/report') }}"
                                    class="bg-red-700 text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Get
                                    Alert</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            <button x-on:click="show = !show" type="button"
                                                ...
                                                <img class="h-8 w-8 rounded-full"
                                                    src="https://pbs.twimg.com/media/GExdZSKaYAAVrhO?format=jpg&name=medium"
                                                    alt="">
                                            </button>
                                        </div>
                                        <div x-show="show"
                                            ...
                                            tabindex="-1">
                                            <a href="{{ url('userprofile') }}" class="block px-4 py-2 text-sm text-gray-700"
                                                role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>

                                            <a href="{{ url('setting') }}" class="block px-4 py-2 text-sm text-gray-700"
