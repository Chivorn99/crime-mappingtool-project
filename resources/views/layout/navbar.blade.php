            ...
            <div class="flex items-center">
                <div class="hidden md:block">
                    <div class="ml-20 flex items-baseline space-x-4">
                        ...
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('user.home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                            @else
