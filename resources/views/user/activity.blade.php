        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-start mb-6">
                    ...
                    <a href="{{ url('userprofileupdate') }}" class="btn btn-primary">Activity</a>
                </div>
                ...
                <div class="mt-5 text-center">
                    <button class="btn btn-primary profile-button" type="button">View Report</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center experience">
                    ...
                    <span class="border px-3 p-1 add-experience"><i class="fa fa-plus"></i>&nbsp;Report</span>
                </div>
                <br>
                <div class="col-md-12">
