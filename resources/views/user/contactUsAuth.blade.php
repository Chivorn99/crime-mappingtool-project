...
<style>
  .background-overlay {
      background-image: url('https://ghostbustersnews.com/wp-content/uploads/2015/08/lego_dimensions_firehouse_01.jpg');
...
<section>
  <div class="container mt-5">
    <div class="row justify-content-center align-items-center min-h-screen">
      ...
      <div class="col-md-8 form-container">
        <form action="/contact-us-auth" method="POST">
          @csrf
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="full_name" class="form-label">Full Name</label>
              <input type="text" class="form-control bg-transparent border border-gray-300" id="full_name" name="full_name" value="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}" required>
            </div>
            <div class="col-md-6 mb-3">
